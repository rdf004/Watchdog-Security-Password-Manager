...
public class PasswordManager extends javax.swing.JFrame {
    ...
    public PasswordManager() 
    {
        ...
        String username = x + "accounts.txt";
        ...
        for (int i = 1; i<=content.size()-2; i++)
        {
            if (i==1)
            {
                Object[] obj = {(content.get(i-1)), (content.get(i)), (content.get(i+1))};
                dtm.addRow(obj);
            }
            else if (i%3==0)
            {
                Object[] obj = {(content.get(i)), (content.get(i+1)), (content.get(i+2))};
                dtm.addRow(obj);
            }
            else
            {
        ...
        jButton4.setText("See Credit Cards");
    ...
    private void seeCreditCards(java.awt.event.ActionEvent evt) //This method defines what happens when jButton1 is clicked
    {
